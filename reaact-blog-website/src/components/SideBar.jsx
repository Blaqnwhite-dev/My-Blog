  ...
  return (
    <div  >
      <div>
        ...
        <div>
          {
            popularBlogs.splice(0, 5).map(blog => <div key={blog.id} className='my-5 border-b-2 border-spacing-3 px-4'>
              <h4 className='font-small mb-2'>{blog.title}</h4>
      ...
      <div>
        ...
        <div>
          {
            popularBlogs.splice(6, 10).map(blog => <div key={blog.id} className='my-5 border-b-2 border-spacing-3 px-4'>
